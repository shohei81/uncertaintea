    ...
    @testset "trunc_logpdf_reference" begin
        ...
        trunc_t_cdf(z, nu) = z > 0 ? 1 - trunc_beta_inc(nu / 2, 0.5, nu / (nu + z^2))[1] / 2 :
    ...
    @testset "trunc_rand" begin
        ...
        trunc_draws = [rand(trunc_rng, trunc_hn) for _ in 1:20000]
        ...
        trunc_t_draws = [rand(trunc_rng_t, trunc_tt) for _ in 1:10000]
    ...
    @testset "trunc_latent_end_to_end" begin
        ...
        trunc_percol = [
            ...
            for i in 1:size(trunc_params, 2)
        ]
